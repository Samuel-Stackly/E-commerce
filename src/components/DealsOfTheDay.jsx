  ...
  return (
    <section className="mx-auto max-w-[1360px] overflow-hidden rounded-xl bg-white p-6 shadow-sm">
      <div className="grid grid-cols-1 items-stretch gap-6 lg:grid-cols-12">
        {/* Left: header + deal content */}
        <div className="flex min-w-0 flex-col gap-6 lg:col-span-10">
          <div className="flex h-[62px] w-full shrink-0 items-center justify-between rounded-[10px] bg-[#1ABA1A] px-6 text-white">
          ...
          <div className="grid flex-1 grid-cols-1 gap-6 lg:grid-cols-10">
            {/* Gallery */}
            <div className="flex min-h-[380px] items-stretch gap-4 lg:col-span-6">
              <div className="flex w-[45px] shrink-0 flex-col justify-between">
              ...
              <div className="relative flex flex-1 items-center justify-center rounded-2xl border border-gray-100 bg-gray-50 p-6">
        ...
        {/* Right: three images match full card height (header → bottom) */}
        <div className="flex flex-col gap-4 lg:col-span-2">
          {sideBanners.map((banner) => (
            <div
              key={banner.src}
              className="relative min-h-[120px] flex-1 overflow-hidden rounded-xl shadow-sm group"
            >
              <img
                src={banner.src}
                alt={banner.alt}
